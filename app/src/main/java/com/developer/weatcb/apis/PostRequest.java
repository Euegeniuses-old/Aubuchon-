package com.developer.weatcb.apis;
                ...
                try {
                    if (listener != null) {
                        if (statusCode == HTTP_BAD_REQUEST) {
                            if (errorResponse.has(Constant.AU_Message) && errorResponse.has(Constant.AU_IsSuccess)) {
                                String msg = errorResponse.getString(Constant.AU_Message);
